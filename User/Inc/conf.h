...
#define GPIO_PORT_KEYS        GPIOA
#define LL_GPIO_PIN_KEY_OK    LL_GPIO_PIN_5
#define LL_GPIO_PIN_KEY_UP    LL_GPIO_PIN_6
#define LL_GPIO_PIN_KEY_DOWN  LL_GPIO_PIN_7
#define LL_GPIO_PIN_KEY_ALL   (LL_GPIO_PIN_KEY_OK|LL_GPIO_PIN_KEY_UP|LL_GPIO_PIN_KEY_DOWN)
#define GPIO_PIN_KEY_OK       GPIO_PIN_5
#define GPIO_PIN_KEY_UP       GPIO_PIN_6
#define GPIO_PIN_KEY_DOWN     GPIO_PIN_7
#define GPIO_PIN_KEY_ALL      (GPIO_PIN_KEY_OK|GPIO_PIN_KEY_UP|GPIO_PIN_KEY_DOWN)
